...
int main()
{
    ...
    process *prc1 = initalizeProcess(1, 10, 3);
    process *prc2 = initalizeProcess(2, 1, 1);
    process *prc3 = initalizeProcess(3, 2, 3);
    process *prc4 = initalizeProcess(4, 12, 4);
    process *prc5 = initalizeProcess(5, 5, 2);
